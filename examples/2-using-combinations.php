...
$overFiveUnderSeventy = new AndSpecification($fivePlus, $seventyOrUnder);

$peopleMatching = $peopleRepo->findSatisfying($overFiveUnderSeventy);

$namedMortimer = new FirstNameIs('Mortimer');
$isSmoker = new IsSmoker();
$smokerNamedMortimer = new AndSpecification(
    $namedMortimer, 
    $isSmoker);

$peopleMatching = $peopleRepo->findSatisfying($smokerNamedMortimer);

$fiveToSeventySmokerMortimer = new AndSpecification(
    $overFiveUnderSeventy, 
    $smokerNamedMortimer);

$peopleMatching = $peopleRepo->findSatisfying($fiveToSeventySmokerMortimer);
